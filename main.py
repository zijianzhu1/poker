...
def main():
    ...
    players_card,remaining_card=distribute_cards(9,all_cards)
    player_with_flop_cards,remaining_card_after_flop,flop_cards=flop_card(remaining_card,players_card)
    player_with_turn_cards, remaining_card_after_turn,turn_cards = turn_card(remaining_card_after_flop, player_with_flop_cards)
    player_with_river_cards, remaining_card_after_river,river_cards = river_card(remaining_card_after_turn,player_with_turn_cards)
    ...
    P_UI=Player_UI(player_board,player_with_river_cards,all_cards,flop_cards,turn_cards,river_cards)
    P_UI.run()
